...
<div class="gdlr-core-pbf-wrapper " style="padding: 105px 0px 80px 0px;" id="gdlr-core-wrapper-4">
  <div class="gdlr-core-pbf-background-wrap">
      <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url({{url('/')}}/public/assets/images/about-us/back.jpg) ;background-size: cover ;background-position: top center ;" data-parallax-speed="0"></div>
  </div>
  <div class="container">
          ...
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class="gdlr-core-title-item-title-wrap ">
                      <h3 class="about-head-first" style="margin-bottom: -40px;">Physicians at MRR Health<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h3>
                  ...
                  <div class="gdlr-core-title-item-title-wrap ">
                   <div class="row">
                    <!-- <i class="fa fa-user-circle" style='font-size;30px;' aria-hidden="true"></i> -->
                     <div class="col-md-3"><img src="public/assets/images/about-us/starb.png" width="40px;">
                      <div id='about-content'>Customer satisfaction</div></div>
                        <div class="col-md-3"><img src="public/assets/images/about-us/bulb.png" width="40px;">
                      <div id='about-content'>Innovation</div></div>
                        <div class="col-md-3"><img src="public/assets/images/about-us/excel.png" width="30px;">
                      <div id='about-content'>Excellence & Reliablity</div></div>
                        <div class="col-md-3"><img src="public/assets/images/about-us/inte.png" width="40px;">
                      <div id='about-content'>Ethical integrity</div></div>
