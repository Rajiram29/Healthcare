...
<div class="gdlr-core-pbf-wrapper " style="padding: 105px 0px 80px 0px;" id="gdlr-core-wrapper-4">
  <div class="gdlr-core-pbf-background-wrap">
      <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url({{url('/')}}/public/assets/images/expertise/mass1.jpg) ;background-size: cover ;background-position: top center ;" data-parallax-speed="0"></div>
  </div>
          ...
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class="gdlr-core-title-item-title-wrap ">
                      <h3 class="contact-head-first" style="color:#f4f4f4ab !important; text-shadow:2px 2px #fcfcfc12;">Mass Tort<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h3>
                      <br>
...
<div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
      <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class=" ">
                      <p class="contact-text-sec" style="color:#f4f4f4ab !important; text-shadow:2px 2px #fcfcfc12;">Pharmaceutical and Mass Tort litigation is incredibly labor intensive and expensive. MRR’s Mass Tort Matrix provides the lowest cost threshold evaluations available and unlike our staff’s time, is billable to the file.
</p>
            ...
            <div class="gdlr-core-pbf-column gdlr-core-column-80 gdlr-core-column-first" id="gdlr-core-column-2706">
                <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="padding: 50px 0px 60px 60px;" data-sync-height="col-features-hp-2" data-sync-height-center>
                    <div class="gdlr-core-pbf-background-wrap">
                        ...
                        <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js massport-home-down1"  data-parallax-speed="0"></div>
                            ...
                            <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 0px;">
                                ...
                                <div class="gdlr-core-column-service-content-wrapper">
                                    <div class="gdlr-core-column-service-title-wrap" style="margin-bottom: 0px ;">
                                                                                                                    ...
                                                                                                                    <div class="container">
                                                                                <h2 class="personal-h2-1">Mass Tort cases we worked</h2>
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    <h4 class="personal-h2-1">Pharmaceuticals:</h4>
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <h4 class="personal-h2-1">Medical Devices:</h4>
                                                                                <ol class="custom-counter">
                                                                                <li>Hip implants (Styker, DuPey, Biomet)</li>
                                                                                <li>Knee replacements (OtisKnee, Zimmer)</li>
                                                                                <li>Mirena IUD</li>
                                                                                <li>Vaginal & bladder mesh (Bard, Caldera, Tyco)</li>
...
<!-- <div class='boo'></div> -->
<!-- 
<div class="container-fluid malpractice-para" style='background-color: #07709112;'>
<br>
<div class="container">
<h2 class="personal-h2-1">Mass Tort cases we worked</h2>
