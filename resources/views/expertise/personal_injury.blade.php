...
<div class="gdlr-core-pbf-wrapper " style="padding: 105px 0px 80px 0px;" id="gdlr-core-wrapper-4">
  <div class="gdlr-core-pbf-background-wrap">
      <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js" style="background-image: url({{url('/')}}/public/assets/images/expertise/head2.jpg) ;background-size: cover ;background-position: top center ;" data-parallax-speed="0"></div>
  </div>
          ...
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class="gdlr-core-title-item-title-wrap ">
                      <h3 class="contact-head-first" style="color:#f4f4f4ab !important; text-shadow:2px 2px #fcfcfc12;">Personal Injury<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h3>
                      <br>
...
<div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
      <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class=" ">
                      <p class="contact-text-sec" style="color:#f4f4f4ab !important; text-shadow:2px 2px #fcfcfc12;">We are doctors, who have an inside perspective of medicine – how it works, what is normal and abnormal</p>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-10 ">
      <h2 class="personal-h2-1">MRR Health Tech Advantage</h2 >
      <p> Our team physicians and medical experts provide case worth analysis and alert the attorneys in helping them choose their personal injury cases more intelligently.</p>
         <p>This way we help law firms to prioritize the case, hence saving time and money for our customers.</p>
    </div>
  </div>  
  <div class="row" style="padding-top:30px; padding-bottom:40px;">
  <div class="col-md-1"></div>
    <div class="col-md-10">
      <h2 class="personal-h2-1">Voluminous Medical Records</h2>
      <p>Our medical team review the voluminous medical records and provide high quality medical summaries and demand letters.</p>
      <p> At MRR Health Tech, we offer a suite of services based on the requirement of a law firm and our services address the attorneys’ requirement at every stage of personal injury litigation process.</p>
...
<div class="gdlr-core-pbf-wrapper " style="padding: 0px 0px 0px 0px;" data-skin="Mediz A1 Column SVC">
    ...
    <div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
        <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-pbf-wrapper-full-no-space">
            <div class="gdlr-core-pbf-column gdlr-core-column-80 gdlr-core-column-first" id="gdlr-core-column-2706">
                <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="padding: 50px 0px 60px 60px;" data-sync-height="col-features-hp-2" data-sync-height-center>
                    <div class="gdlr-core-pbf-background-wrap">
                        ...
                        <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js massport-home-down2"  data-parallax-speed="0"></div>
                            ...
                            <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr" style="padding-bottom: 0px;">
                                ...
                                <div class="gdlr-core-column-service-content-wrapper">
                                    ...
                                    <div class="container">
                                                                        ...
                                                                        <!-- <div class="col-md-1"></div> -->
                                                                        <div class="col-md-10">
                                                                        <h2 class="personal-h2-1">Personal injury cases we work:</h2>

                                                                        <ol class="custom-counter-malpractice">
                                                                        <li>  Back injuries, e.g. caused by lifting heavy or awkward objects.</li>
                                                                        <li>  Post-traumatic stress disorder, e.g. road accident, military situation</li>
                                                                        <li>  Whiplash, e.g. car accident</li>
                                                                        <li>  Hand/wrist injuries, e.g. RSI, carpal tunnel syndrome etc</li>
                                                                        <li>  Ear injuries, e.g. noise induced deafness</li>
                                                                        <li>  Head injuries, e.g. road accident, physical assault, sport etc</li>
                                                                        <li>  Psychiatric injuries, e.g. stress, workplace bullying, accident etc</li>
                                                                        <li>  Leg injuries, e.g. sport, cycling accidents, slips, trips and falls.</li>
                                                                        <li>  Eye injuries, e.g. foreign body in eye, chemical splashes, sport, physical assault etc.</li>
                                                                        <li>  Arm injuries, e.g. workplace, sport, falls etc</li>
                                                                        </ol>
                                                                        </div>
...
<div class="gdlr-core-pbf-wrapper " style="padding: 70px 0px 0px 0px;" data-skin="Mediz HP Column SVC">
    <div class="gdlr-core-pbf-background-wrap"></div>
...
<div class="row">
  ...
  <!-- what client says -->
<div class="gdlr-core-pbf-wrapper" style="padding: 50px 0px 10px 0px;background-color: #025c610d;" id="gdlr-core-wrapper-4">
  <div class="gdlr-core-pbf-background-wrap">
  ...
  <div class="gdlr-core-pbf-wrapper-content gdlr-core-js" style="border-style: solid;
