...
<head>
  ...
  <link rel="stylesheet" href="{{url('/')}}/public/assets/css/lightgallery.min.css" />
  <link rel="stylesheet" href="{{url('/')}}/public/assets/css/animate.css" />
  <link rel="stylesheet" href="{{url('/')}}/public/assets/css/jQueryUi.min.css" />
  <link rel="stylesheet" href="{{url('/')}}/public/assets/css/textRotate.css" />
...
<body class="st-green">
        ...
        <div class="st-top-header-in">
          <ul class="st-top-header-list">            
            <li>
              ...
              <a href="mailto:info@nischinto.com">info@nischinto.com</a></li>
            <li>
          ...
          <a href="{{url('/')}}/secure-file-upload" class="st-top-header-btn st-smooth-move">Secure File Upload</a>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="st-main-header-in">
          <div class="st-main-header-left">
            <a class="st-site-branding" href="{{url('/')}}/"><img src="{{url('/')}}/public/assets/img/logo.png" alt="Nischinto"></a>
          </div>
          <div class="st-main-header-right">
            <div class="st-nav">
              <ul class="st-nav-list st-onepage-nav">
                 <li><a href="{{url('/')}}/" class="st-smooth-move">Home</a></li> 
                  <li><a href="{{url('/')}}/services" class="st-smooth-move">Services</a></li> 
                 <li class="menu-item-has-children"><a href="#" class="st-smooth-move">Expertise</a>
                  <ul>
                    <li class="menu-item-has-children"><a href="{{url('/')}}/personal-injury">Personal Injury</a></li>
                    <li class="menu-item-has-children"><a href="{{url('/')}}/personal-injury">Medical Malpractice</a></li>
                    <li class="menu-item-has-children"><a href="{{url('/')}}/personal-injury">Mass Tort</a></li>
                  </ul>
                </li>

                <li><a href="{{url('/')}}/samples" class="st-smooth-move">Samples</a></li>
                <li><a href="{{url('/')}}/about-us" class="st-smooth-move">About Us</a></li>
                <li><a href="{{url('/')}}/contact-us" class="st-smooth-move">Contact Us</a></li> 

                <li><a href="{{url('/')}}/login" class="st-top-header-btn st-smooth-move btn-green"  >Login</a></li>
  ...
  <div class="st-content">
    ...
    <section id="appointment" class="st-shape-wrap ">
      ...
      <div class="login-page" style="padding: 70px 0 0">
  <div class="form">
      <div class="st-text-block-avatar" style="text-align: center;
    display: contents;">
                     
                    <div class="st-avatar-info" style="padding-bottom: 15px;">
  ...
  <script src="{{url('/')}}/public/assets/js/isotope.pkg.min.js"></script>
  <script src="{{url('/')}}/public/assets/js/jquery.slick.min.js"></script>
  <script src="{{url('/')}}/public/assets/js/mailchimp.min.js"></script>
  <script src="{{url('/')}}/public/assets/js/counter.min.js"></script>
  <script src="{{url('/')}}/public/assets/js/lightgallery.min.js"></script>
  <script src="{{url('/')}}/public/assets/js/ripples.min.js"></script>
  <script src="{{url('/')}}/public/assets/js/wow.min.js"></script>
  <script src="{{url('/')}}/public/assets/js/jQueryUi.js"></script>
  <script src="{{url('/')}}/public/assets/js/textRotate.min.js"></script>
