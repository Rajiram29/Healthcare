          ...
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class="gdlr-core-title-item-title-wrap ">
                      <h3 class="contact-head-first1" style="text-align:center;float:none;">Bookmarks<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h3>
                      <br>
...
<div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
      <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class=" ">
                      <p class="contact-text-sec1" style="text-align:center !important; float:none;">PDF bookmarks are considered a clickable table of contents list that are available on the left side of the PDF document (medical records) and can be used to quickly browse/access various pages in the source PDF document at ease.</p>
...
<div class="container">
	...
	<h1 class="heading header-clr">Bookmarks</h1>
<div class="row">
...
<div class='col-md-12'>
	...
	<!-- <div class="gallery"> -->
		...
		<div class="gallery-item">
			...
			<img class="gallery-image" src="public/assets/images/all/bookmarks.png" style="height:540px; width:100%;  object-fit: unset;" alt="person writing in a notebook beside by an iPad, laptop, printed photos, spectacles, and a cup of coffee on a saucer">    
...
<p>Allow the reader to quickly locate and link to the points of interest within the medical record.</p>

<ol class="custom-counter">
    <li>Record Type Bookmarks</li>
    <li>Provider Wise Bookmarks</li>
    <li>Chronological Bookmarks</li>
   </ol>
