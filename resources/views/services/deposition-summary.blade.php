          ...
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class="gdlr-core-title-item-title-wrap ">
                      <h3 class="contact-head-first1" style="text-align:center;float:none;">Deposition Summary<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h3>
                      <br>
...
<div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
      <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class=" ">
                      <p class="contact-text-sec1" style="text-align:center !important; float:none;">This report identifies important medical points in the deposition by page and line. “Page-Line” summaries are typically formatted to include columns for.</p>
                      <p class="contact-text-sec1"> 1. Page-line </p>
                      <p class="contact-text-sec1"> 2. exhibit </p>
                      <p class="contact-text-sec1"> 3. Summary of the testimony </p>
...
<div class="container">
	...
	<h1 class="heading header-clr">Deposition Summary</h1>
<div class="row">
...
<div class='col-md-6'>
	...
	<div class="gallery">
		...
		<div class="gallery-item">
			...
			<img class="gallery-image" src="public/assets/images/all/deposition.png" style="height:540px;  object-fit: unset;" alt="person writing in a notebook beside by an iPad, laptop, printed photos, spectacles, and a cup of coffee on a saucer">    
...
<p>We understand that the deposition testimony is a key event in a civil lawsuit and the litigant’s deposition is his opponent’s only opportunity before trial to hear the party’s version of what happened, spoken in his own words. Summarizing hours of deposition testimony into a concise summary is a valuable skill that can save hours of lawyers’ time and thousands of dollars in legal fees. We do precisely that, and additionally, we also direct you to the case focus areas. We accurately record dates, figures, names, and exhibits; give a record of key events and actions.</p>

<h4 class="header-clr1">Topic – Deposition Summary</h4>
<p>Organize the testimony into specific relevant topics of your choice for a quick overview ie by medical, military and work history.</p>
<h4 class="header-clr1">Page-Line Deposition Summary</h4>
<p>The transcript is summarized in order, separated into topics with relevant page-line references. Useful for easy deposition navigation and gaining a comprehensive understanding of the entire testimony and facts.</p>
