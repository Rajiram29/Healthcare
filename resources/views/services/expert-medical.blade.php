          ...
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class="gdlr-core-title-item-title-wrap ">
                      <h3 class="contact-head-first1" style="text-align:center;float:none;">Expert Medical Opinion<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h3>
                      <br>
...
<div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
      <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class=" ">
                      <p class="contact-text-sec1" style="text-align:center !important; float:none;">Medical Opinions involve reviewing the medical documents including the medical summary of a patient and figuring out if there is negligence/malpractice involved in the standard of care given to that patient. In order to simplify medical jargon, we also present this data in a way that a non-medical person could understand, along with references from standard medical books or literature.</p>
...
<div class="container">
	...
	<h1 class="heading header-clr">Expert Medical Opinion</h1>
<div class="row">
...
<div class='col-md-6'>
	...
	<div class="gallery">
		...
		<div class="gallery-item">
			...
			<img class="gallery-image" src="public/assets/images/all/expert.png" style="height:540px;  object-fit: unset;" alt="person writing in a notebook beside by an iPad, laptop, printed photos, spectacles, and a cup of coffee on a saucer">    
...
<p>Our physicians give an Medical opinion on the medical case with valid reasoning and inferences in a question and answer format.</p>

<ol>
    <li>Involves a thorough evaluation of all the patient’s medical records to assess whether or not there has been a deviation in the standard of care for the patient</li>
    <li>Medical opinions are useful for a preliminary case evaluation</li>
    <li>Medical opinions are prepared by case speciality relevant MD’s</li>
    <li>Opinions are given in a simple Q&A format for easy interpretation</li>
    <li>Medical opinions are strongly supported by evidence from high impact factor journals and publication from standard scientific sources</li>
...
<p>Physician at MRR Health Tech’s analyze the personal injury cases and report the causation. Our report clearly defines if the victim was “egg shell” plaintiff when the accident/incident occurred.  All the relevant pre-existing illness is analyzed and the attorney is given an alert at an early stage.  At MRR Health Tech doctors from the various specialities such orthopedics, physiatry, neurology and neurosurgery evaluate the medical records and provide expert opinion that would be valuable for a successful claim.</p>
  ...
  <div class="col-md-6">
  <h4 class="header-clr1">Expert Medical Opinion (Medical Malpractice)</h4>  
  <p>Medical malpractice cases almost always require a medical expert or a team of medical experts to prove liability. It is often difficult to get an unbiased medical opinion within the practice region due to peer pressure among the practicing medical experts in that region. At MRR Health Tech, we retain Indian doctors from the various specialities, who do not have personal relation or professional affiliation with the defendants. Our doctors perform dispassionate review of the medical records and provide unbiased expert opinion that would be difficult to refute. Our doctors’ opinion is based on the prevailing standard treatment protocol that is followed in the United States health care system. Medical opinion carries the critical appraisal of the treatment followed in the subject in question versus the right /approved medical protocol.</p>

  <h4 class="header-clr1">Quick Merit Screening Report (Medical Malpractice)</h4>  
  <p>Validating the medical negligence allegation at the early stage of litigation will save a lot of time for the attorney. Suits will have more quality and the chance of winning a medical malpractice case is high, when screened by a physician or the specialist medical expert.   With MRR Health Tech medical specialists merit screening report, attorney will be at an advantageous position to understand the depth of the case and help you strategize your case more efficiently.</p>
  </div>
</div>
