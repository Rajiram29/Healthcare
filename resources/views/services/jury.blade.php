          ...
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class="gdlr-core-title-item-title-wrap ">
                      <h3 class="contact-head-first1" style="text-align:center;float:none;">Jury Questionnaire Summaries<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h3>
                      <br>
...
<div class="container">
	...
	<h1 class="heading header-clr">Jury Questionnaire Summaries
</h1>
<div class="row">
...
<div class='col-md-12'>
	...
	<!-- <div class="gallery"> -->
		...
		<div class="gallery-item">
			...
			<img class="gallery-image" src="public/assets/images/all/jury.png" style="height:540px; width:100%;  object-fit: unset;" alt="person writing in a notebook beside by an iPad, laptop, printed photos, spectacles, and a cup of coffee on a saucer">    
...
<p><b>Improve Your Jury Selection With Questionnaire Summaries</b></p>

<p>During jury selection often thousands of pages of completed jury questionnaires are compiled. Important juror details may be overlooked due to the sheer volume of data and time constraints.</p>

<p><b>Our Solution – Questionnaire Summaries ($15 per juror & 12 hour turnaround time)</b></p>
<ol class="custom-counter">
    <li>Email us completed juror questionnaires (MS Word)</li>
    <li>Provide us with key criteria in a template format</li>
    <li>Receive a searchable database for future firm use</li>
    <li>Coded fields for exporting answers into a database</li>
