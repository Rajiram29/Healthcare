          ...
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class="gdlr-core-title-item-title-wrap ">
                      <h3 class="contact-head-first1" style="text-align:center;float:none;">Med-A-Word/Med-Interpret<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h3>
                      <br>
...
<div class="container">
	...
	<h1 class="heading header-clr">Med-A-Word/Med-Interpret
</h1>
<div class="row">
...
<div class='col-md-12'>
	...
	<!-- <div class="gallery"> -->
		...
		<div class="gallery-item">
			...
			<img class="gallery-image" src="public/assets/images/all/med.png" style="height:540px; width:100%;  object-fit: unset;" alt="person writing in a notebook beside by an iPad, laptop, printed photos, spectacles, and a cup of coffee on a saucer">    
...
<ol class="custom-counter">
    <li>It enhances the comprehension of medical terminology appearing in medical chronologies or deposition transcripts</li>
    <li>Pop-ups instantaneously for the medical term.</li>
