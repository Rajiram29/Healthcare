          ...
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class="gdlr-core-title-item-title-wrap ">
                      <h3 class="contact-head-first1" style="text-align:center;float:none;">Medical Narrative Summary<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h3>
                      <br>
...
<div class="container">
	...
	<h1 class="heading header-clr">Medical Narrative Summary</h1>
<div class="row">
...
<div class='col-md-6'>
	...
	<div class="gallery">
		...
		<div class="gallery-item">
			...
			<img class="gallery-image" src="public/assets/images/all/narrative.png" style="height:540px;  object-fit: unset;" alt="person writing in a notebook beside by an iPad, laptop, printed photos, spectacles, and a cup of coffee on a saucer">    
...
<p>Our MD’s are trained to prepare Narrative Summaries for a diverse list of specialties including, motor vehicle accidents, pedestrian accidents, worker’s compensation burns, dog bites assault, emotional and sexual harassment, disability, and falls. We customize our summary to best meet the needs of your case.</p>

<ol>
    <li>Narrative summaries are prepared by our MD’s and are Bate stamped</li>
    <li>Gives you all the information in an easy to follow narrative story telling format that will help get a quick idea of event flow</li>
    <li>These summaries are perfect for deposition as well as demand preparation</li>
    ...
    <li>Additional reports for medications and other investigations can be added</li>
    <li>The Summary is delivered based on client request either in a WORD or PDF format</li>
    <li>PDF Summaries can be obtained with additional services –</li>
    <li>Hyperlinks – Allows you to quickly navigate to a reference page</li>
    <li>Bookmarks – Allows the document to be organized as per user defined categorie</li>
</ol>
