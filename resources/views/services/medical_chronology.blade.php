          ...
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class="gdlr-core-title-item-title-wrap ">
                      <h3 class="contact-head-first1">Medical Chronology | Summary | Timeline<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h3>
                      <br>
...
<div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
      <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class=" ">
                      <p class="contact-text-sec1" style="text-align:center !important; float:none;">Our doctors are preparing medical chronology & summary for $25 Per Hour</p>
...
<div class="container">
	...
	<h1 class="heading header-clr">Medical Chronology/Summary Samples</h1>
<div class="row">
...
<div class='col-md-6'>
	...
	<!-- <div class="gallery"> -->
		...
		<div class="gallery-item">
			...
			<img class="gallery-image" src="public/assets/images/all/medical.png" style="height:540px;  object-fit: unset;" alt="person writing in a notebook beside by an iPad, laptop, printed photos, spectacles, and a cup of coffee on a saucer">    
...
">Medical Chronology/Summary Samples</a>
  </div>
...
<p><b>A medical Summary/Chronology</b> is a record of medical events in the order of their occurrence. This involves reading through pages of medical records to identify, locate, review and interpret relevant medical records. Keeping in mind the voluminous medical records attorneys receive for every case it would be an strenuous process to probe into each medical record and identify their relevance in terms of the case. This is where a Chronology would help. After an attorney provides us with a Case focus, our team will create a Medical summary of events known as Chronology. This helps law firms settle cases effectively and as quickly as possible, as it makes the whole case discovery process even simpler. At the basic level, the Chronology is sorted by Date.</p>

<p><b>Medical Chronology</b> for law firms is an important service that enables lawyers to have a clear and organized view of the medical chart of a patient. A well-presented chronology highlights important issues and even many facts that might have evaded notice. A medical chart is especially significant with regard to tracing the administration of medication, patterns of care and other associated aspects. Medical records are many and these need to be effectively streamlined to understand a claim related case and take the correct decision.</p>
...
<div class='col-md-6'>
<p>There is a simple way out. Send us your client’s medical records and tell us what the case is about. We can draft the summary containing the needed details, thereby substantiating your case for you, on your behalf.</p>

<h4 class="header-clr1">Types:</h4>
<ol>
<li>Date Order Summary </li>
<li>PDF Sorted Chronology</li>
<li>Bates Stamped Chronology</li>
</ol>

<h4 class="header-clr1">The standard chronology includes:</h4>
<ul>
<li> Symptoms</li>
<li> Diagnosis</li>
<li> Treatment</li>
<li>Treating Organization </li>
...
<div class="col-md-6">
<h4 class="header-clr1"> 
Our Chronology would benefit you in the following ways:
</h4>

<ul>
<li><b>Hyperlinked to the Source:</b> Every record that is summarized comes with its click-through source (a link to the original record) – Optional service.</li>
<li><b>Key facts:</b> Our reviewers highlight key facts in the Chronology that help you better prepare witnesses for Deposition.</li>
<li><b>Missing records:</b> We inform you about missing records.</li>
<li><b>Summarization of medical records:</b>  The pile of medical records on any given case is huge and details in each sheet are voluminous. It is very taxing for any legal person.</li>
</ul>
