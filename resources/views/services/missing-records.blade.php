          ...
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class="gdlr-core-title-item-title-wrap ">
                      <h3 class="contact-head-first1" style="text-align:center;float:none;">Missing Records Identification<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h3>
                      <br>
...
<div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
      <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class=" ">
                      <p class="contact-text-sec1" style="text-align:center !important; float:none;">
</p>
...
<div class="container">
	...
	<h1 class="heading header-clr">Missing Records Identification
</h1>
<div class="row">
...
<div class='col-md-12'>
	...
	<!-- <div class="gallery"> -->
		...
		<div class="gallery-item">
			...
			<img class="gallery-image" src="public/assets/images/all/missing.jpg" style="height:540px; width:100%;  object-fit: unset;" alt="person writing in a notebook beside by an iPad, laptop, printed photos, spectacles, and a cup of coffee on a saucer">    
...
<!-- <p>Hover your cursor over a medical term and a window pops up instantaneously with the meaning of the word.</p> -->

<ol class="custom-counter">
    <li>Document review captures provider name, date of service, next appointment, medical bills and gaps in treatment which are matched against provided records</li>
    <li>Search for documents common to case type Ex. Autopsy for death case</li>
    <li>A detailed list of missing records to retrieve is forwarded including dates, providers, the record type and their importance to case analysis</li>
    <li>Report provided gratis with your Chronologies, Mass Tort Evaluations and Medical Opinions</li>
    <!-- <li><b>Free Hyperlinks for your all cases!</b></li> -->
   </ol>
<p>Definition pop-ups of medical summary or deposition terms appear by mousing over the desired term</p>
