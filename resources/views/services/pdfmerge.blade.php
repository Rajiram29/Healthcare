          ...
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class="gdlr-core-title-item-title-wrap ">
                      <h3 class="contact-head-first1" style="text-align:center;float:none;">PDF Merging & Sorting<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h3>
                      <br>
...
<div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
      <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class=" ">
                      <p class="contact-text-sec1" style="text-align:center !important; float:none;">We arrange the mixed up medical records in the order of your preference. We specialize in sorting the medical records based on chronological occurrences (date-wise), provider and service types. We can also custom sort the medical records based on your preferences</p>
...
<div class="container">
	...
	<h1 class="heading header-clr">PDF Merging & Sorting
</h1>
<div class="row">
...
<div class='col-md-6'>
	...
	<!-- <div class="gallery"> -->
		...
		<div class="gallery-item">
			...
			<img class="gallery-image" id="myImg2" src="public/assets/images/all/pdf1.png" style="height:540px; width:100%;  object-fit: unset;" alt="person writing in a notebook beside by an iPad, laptop, printed photos, spectacles, and a cup of coffee on a saucer">  
...
<!-- <div class="gallery"> -->
    ...
    <div class="gallery-item">
        ...
        <img class="gallery-image" id="myImg" src="public/assets/images/all/pdf2.png" style="height:540px; width:100%;  object-fit: unset;" alt="">    

        <!-- <img id="myImg" src="public/assets/images/all/jury.png" alt="Snow" style="width:100%;max-width:300px"> -->
...
<div class="row">
    ...
    <div class="col-md-4">  <div class="container-gallery" style="padding-top:30px; padding-left:25px;"> 
...
<p><b>Record wise PDF Sorting</b></p>

<p>The entire medical records will be merged and then sorted for each record type i.e. Nursing Notes, Discharge summary, Wound Assessment records, etc.</p>

</div>
    
<div class='col-md-4'>

<p><b>Provider wise PDF Sorting</b></p>

<p>The records are sorted by provider (i.e. Provider A, Provider B)</p>
...
<p><b>Chronological PDF Sorting</b></p>

<p>The entire set of medical records are sorted as per date irrespective of provider</p>
