          ...
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class="gdlr-core-title-item-title-wrap ">
                      <h3 class="contact-head-first1" style="text-align:center;float:none;">Settlement Demand Letter<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h3>
                      <br>
...
<div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
      <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
          <div class="gdlr-core-pbf-element">
              <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                  <div class=" ">
                      <p class="contact-text-sec1" style="text-align:center !important; float:none;">Our MD’s are drafting settlement demand letter along with Billing Summary & Exhibits.</p>
...
<div class="container">
	...
	<h1 class="heading header-clr">Settlement Demand Letter</h1>
<div class="row">
...
<div class='col-md-6'>
	...
	<div class="gallery">
		...
		<div class="gallery-item">
			...
			<img class="gallery-image" src="public/assets/images/all/settlement.png" style="height:540px;  object-fit: unset;" alt="person writing in a notebook beside by an iPad, laptop, printed photos, spectacles, and a cup of coffee on a saucer">    
...
<p>A personal injury demand letter summarizes the history of your personal injury claim for the insurance adjuster. It begins at the point of impact and ends with your last day of treatment. It guides the adjuster through all you’ve lost as a result of the insured’s negligence. A well-written demand letter can effectively limit the adjuster’s options for objecting to the amount of your settlement demand.</p>

<ol class="custom-counter">
    <li>Demand settlement letters clearly highlight all the accident events with an aim to garner greater compensation</li>
    <li>Gives a perfect summary of facts describing the incidence</li>
    <li>In-depth description of all the injuries sustained, procedures and associated bills and expenses</li>
    <li>Statement of loss of income and other associated expenses</li>
    <li>Clear description on the impaired quality of life were appropriate</li>
    <li>Clear settlement on injury settlement demand amount</li>
</ol>
...
<div class="col-md-6">
    <p>The purposes of a demand letter are to establish:</p>
    <ol class="custom-counter">
        <li>Why the other party is legally responsible for your injury or suffering</li>
        <li>What your injuries were and how much you lost by treating them</li>
        <li>Any other damages incurred as a result of the accident</li>
</ol>
<p>Having a good demand letter that clearly states a factual summary, your claim for damages, a claim for pain and suffering, and your demand for settlement can make all the difference in getting your claim positively settled out of court without having to endure a long and exhausting court battle. Our demand letters take into account all the evidence that is on record pertaining to your case. In doing so, our demand letters are complete and concise to ensure that you get a prompt and fair settlement as quickly as possible.</p>
</div>
<div class="col-md-6">
    <p>The purposes of a demand letter are to establish:</p>
    <ol class="custom-counter">
